...
public class CodeChecksum
{
    ...
    public static CodeChecksum Compute(Procedure procedure, BinaryBaseImage image)
    {
    ...
    private static void ComputeMore(
        HashAlgorithm hasher, Procedure procedure, BinaryBaseImage image)
    {
    ...
    /// </summary>
    private static void ComputeMore(
        HashAlgorithm hasher, BasicBlock basicBlock, BinaryBaseImage image)
    {
