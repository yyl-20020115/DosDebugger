...
public class BasicBlock
{
    ...
    public BasicBlock(Address begin, Address end, BasicBlockType type, BinaryBaseImage image)
    {
    ...
    public IEnumerable<Instruction> GetInstructions(BinaryBaseImage image)
    {
...
public class BasicBlockCollection : ICollection<BasicBlock>
{
    ...
    public BasicBlock[] SplitBasicBlock(BasicBlock block, Address cutoff, BinaryBaseImage image)
    {
        ++TimesSplit;
        if (block == null)
            throw new ArgumentNullException(nameof(block));
