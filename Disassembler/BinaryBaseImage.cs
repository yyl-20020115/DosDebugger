...
/// </remarks>
public abstract class BinaryBaseImage
{
...
public class ByteAttributeCollection(BinaryBaseImage image)
{
    readonly List<ByteAttribute[]> attrs = [];
    readonly BinaryBaseImage image = image;
