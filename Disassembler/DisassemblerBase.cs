...
/// </summary>
public abstract class DisassemblerBase(BinaryBaseImage image)
{
    protected readonly BinaryBaseImage image = image ?? throw new ArgumentNullException(nameof(image));
